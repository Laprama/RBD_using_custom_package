...
for data_type in  ['REM', 'N1', 'N2', 'N3', 'Wake']:
    for expt_num in [1,2]:
        for num_splits in [4]:
            ...
            DT_dict = {'DT' : GridSearchCV( DecisionTreeClassifier(random_state = 5), DT_params , refit = True, verbose = 1, cv = GroupKFold(n_splits = num_splits) ) }
            ...
            Ada_dict = {'Ada' : GridSearchCV( AdaBoostClassifier(random_state = 5), Ada_grid , refit = True, verbose = 1, cv = GroupKFold(n_splits = num_splits) ) }
...
folder = '/user/home/ko20929/work/RBD_using_custom_package/Execute New Experiments/Baseline_Extensions/Fitting Hyperparam Test/tuned_region_only_models_and_results/run_2'
