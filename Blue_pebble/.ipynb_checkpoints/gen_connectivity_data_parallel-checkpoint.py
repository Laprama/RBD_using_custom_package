...
for path in paths['selected_paths']:
    ...
    con_pli =  spectral_connectivity_epochs(data_epo , method=method , sfreq=256,fmin=fmin, fmax=fmax, faverage=True)
...
connectivity_df.to_hdf(folder + data_type + '_' + method + '_' + '_df.h5' , key = 'df' , mode = 'w')
