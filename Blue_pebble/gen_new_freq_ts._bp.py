...
# Changeing this to work on BP 
# 1 - load paths (done) , 2. save paths (done) , 3. Input argument from array  (DONE)
...
for data_type in [data]:   
    ...
    folder = '/user/work/ko20929/freq_6_second_files/'
